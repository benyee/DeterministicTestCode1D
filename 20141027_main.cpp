...
int main ()
{
    ...
    static const double eps[] = {1, 0.9, 0.5, 0.4,0.3,0.2,0.1, 0.09,0.08,0.07,0.05,0.04,0.03, 0.01, 0.007, 0.005, 0.003, 0.001, 1e-4, 1e-5, 1e-6, 1e-7};
    ...
    static const double sigma_a0 = 1.0;
    static const double Q0 = 1.0;
