...
int main ()
{
    ...
    /* Epsilon Problem */
    static const double X = 40;
    static const double dx_arr[] = {8,4,2,1,0.5,0.25,0.01};
        ...
        for(int j = dx.size()-1; j>=0;j--){
            for(unsigned int m = 0; m<alpha_mode.size();m++){
                for(unsigned int i = 0; i<accel_size;i++){
                    ...
                    ostringstream ss;
                    if(m == 0){
                        ss<<"OutputFiles/output_10_DD_"<<k<<"_"<<j<<"_"<<i<<"_.txt";
                    }else if (alpha_mode[m] ==30){
                        ss<<"OutputFiles/output_10_new_"<<k<<"_"<<j<<"_"<<i<<"_.txt";
                    }else if (alpha_mode[m] ==2){
                        ss<<"OutputFiles/output_10_SC_"<<k<<"_"<<j<<"_"<<i<<"_.txt";
                    }else{
                        ss<<"OutputFiles/output_10_"<<alpha_mode[m]<<"_"<<j<<"_"<<k<<"_"<<i<<"_.txt";
                    }
