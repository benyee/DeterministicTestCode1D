...
int main ()
{
    ...
    static const double alpha_arr[] = {0,31};
    ...
    for(unsigned int m = 0; m<alpha_mode.size();m++){
        for(unsigned int j = 0; j<dx.size();j++){
            for(unsigned int k = 0; k<SigS.size();k++){
                ...
                ostringstream ss;
                if(m == 0){
                    ss<<"OutputFiles/output_6_DD_"<<j<<"_"<<k<<"_.txt";
                }else if (alpha_mode[m] == 31){
                    ss<<"OutputFiles/output_6_new1_"<<j<<"_"<<k<<"_.txt";
                }else if (alpha_mode[m] == 2){
                    ss<<"OutputFiles/output_6_SC_"<<j<<"_"<<k<<"_.txt";
                }else{
                    ss<<"OutputFiles/output_6_"<<alpha_mode[m]<<"_"<<j<<"_"<<k<<"_.txt";
                }
